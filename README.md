...
[![GitHub Stars](https://img.shields.io/github/stars/sb4486/orchestrai?label=Stars&style=for-the-badge)](https://github.com/sb4486/OrchestrAI) 
[![Latest Release](https://img.shields.io/github/v/tag/sb4486/orchestrai?style=for-the-badge&label=Latest)](https://github.com/sb4486/OrchestrAI)

> **Note:** Demo videos and documentation available in the individual feature sections below.
...
-   CI/CD via Github Actions
    -   💲 Deploy live demo to [![Fargate](https://img.shields.io/badge/Fargate-white.svg?logo=awsfargate)](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html)
...
|-----------|---------------|-------------|
| 🔗 **MCP** | [\`docs/mcp.md\`](./docs/mcp.md) | Model Context Protocol integration |
| 🕸️ **LangGraph** | [\`docs/langgraph.md\`](./docs/langgraph.md) | Agentic workflow orchestration |
| 🗄️ **Supabase** | [\`docs/supabase.md\`](./docs/supabase.md) | Database and authentication setup |
| 📊 **Langfuse** | [\`docs/langfuse.md\`](./docs/langfuse.md) | LLM observability and monitoring |
| 📈 **Grafana Stack** | [\`docs/grafana-stack.md\`](./docs/grafana-stack.md) | Metrics and visualization |
